...
Module Volume_do_Windows
   ...
   Public Sub btnMute_Click(ByVal sender As Object, ByVal e As EventArgs)
	 SendMessageW(sender.Handle, WM_APPCOMMAND,
				sender.Handle, New IntPtr(APPCOMMAND_VOLUME_MUTE))
   End Sub

   Public Sub btnDecVol_Click(ByVal sender As Object, ByVal e As EventArgs)
	 SendMessageW(sender.Handle, WM_APPCOMMAND,
			    sender.Handle, New IntPtr(APPCOMMAND_VOLUME_DOWN))
   End Sub

   Public Sub btnIncVol_Click(ByVal sender As Object, ByVal e As EventArgs)
	 SendMessageW(sender.Handle, WM_APPCOMMAND,
